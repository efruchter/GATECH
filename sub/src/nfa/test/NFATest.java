...
public class NFATest {
	...
	public void test() {
		...
		assertTrue(
				"a*b*",
				NFAUtil.isValid(n, "ab") && NFAUtil.isValid(n, "a")
						&& NFAUtil.isValid(n, "abbbb")
						&& NFAUtil.isValid(n, "")
						&& NFAUtil.isValid(n, "aaaabbbbb")
						&& !NFAUtil.isValid(n, "bbbbaaaa")
		...
		s.addTransition(new Transition('a', s), new Transition('b', s),
				new Transition(s0));
		...
		assertTrue(
				"(a|b)*(ab)+",
				!NFAUtil.isValid(n, "")
						&& NFAUtil.isValid(n, "ab")
						&& !NFAUtil.isValid(n, "babababa")
						&& NFAUtil.isValid(n, "bababab")
						&& NFAUtil
								.isValid(n,
										"bababababababbbbbbabababababaaaaaaaaaaabbbbaaab"));
	}
	...
	public void FactoryMethodTests() {
		...
		assertTrue(
				"a(a|b)*b",
				NFAUtil.isValid(n, "ab") && NFAUtil.isValid(n, "abababab")
						&& NFAUtil.isValid(n, "aabababababbaabbaab")
						&& NFAUtil.isValid(n, "ababb")
						&& NFAUtil.isValid(n, "abbbbbbaaaaaaaabbbbbb")
						&& !NFAUtil.isValid(n, "bbbbaaaa")
						&& !NFAUtil.isValid(n, "aaaabbbbbbbbba"));
		...
		s.addTransition(Transition.createTransition('a', s),
				Transition.createTransition('b', s),
